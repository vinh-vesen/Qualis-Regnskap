  ...
  return (
    <>
      ...
      <StyledText>
        ...
        du vil være med i prosessen. Vi kan samarbeide på forskjellige måter. Vi
        kan utføre alt, dere kan utføre deler av oppgavene eller vi kun skal
        kontrollere. Vi sørger for at bedriftens behov blir ivaretatt. Vi
